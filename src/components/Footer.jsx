...
export default function Footer() {
  return (
    <footer className="footer-wrapper flex w-screen pt-10 px-10 items-center">
      <div className="footer-container w-full flex justify-between">
        ...
        <div className="contact-us-container flex flex-col gap-10">
          ...
          <div className="contact-container flex flex-col gap-4">
            ...
            <p className="w-auto">
            email:
            <a href="mailto:ptnailsandbarmilton@gmail.com"> ptnailsandbarmilton@gmail.com</a>
          </p>
          </div>
        </div>
        <div className="business-hour-container flex flex-col gap-10">
          ...
          <ul className="flex flex-col gap-4">
            ...
            <li>Sat: 10am - 4pm</li>
            <li>Sun: 10am-4pm</li>
            <li>Holiday hours may change</li>
          </ul>
        </div>
      </div>
    </footer>
